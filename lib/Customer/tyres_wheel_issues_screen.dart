...
class _TyresWheelIssuesScreenState extends State<TyresWheelIssuesScreen> {
  ...
  String _romanIssue(String issue) {
    const translations = {
      'Flat tire or puncture': 'Tyre puncture ya flat hai',
      'Steering wheel vibration': 'Steering wheel vibrate kar raha hai',
      'Low tire pressure': 'Tyre pressure kam hai',
      'Vehicle pulling to one side': 'Gaari ek taraf khinch rahi hai',
      'Uneven tire wear': 'Tyre ghisawat barabar nahin hai',
      'Bent or damaged rim': 'Rim murha ya kharab hai',
    };
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    AppText.of(
                      context,
                      english: 'Tyres & Wheel Issues',
                      romanUrdu: 'Tyre Aur Wheel Masail',
                    ),
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                AppText.of(
                                  context,
                                  english: 'Common Tyres & Wheel Issues',
                                  romanUrdu: 'Aam Tyre Aur Wheel Masail',
                                ),
                                style: const TextStyle(
                                  fontSize: 15,
