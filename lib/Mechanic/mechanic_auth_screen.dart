                      ...
                      children: [
                        ...
                        Text(
                          _isLogin
                              ? AppText.of(
                                  context,
                                  english: 'Sign in to manage your workshop',
                                  romanUrdu:
                                      'Apni workshop manage karne ke liye sign in karein',
                                )
                              : AppText.of(
                                  context,
                                  english:
                                  ...
                                  romanUrdu:
                                      'Job requests lene ke liye register karein',
                                ),
                          style: const TextStyle(
                            fontSize: 14,
                          ...
                          children: [
                            Text(
                              _isLogin
                                  ? AppText.of(
                                      ...
                                      romanUrdu: 'Account nahi hai? ',
                                    )
                                  : AppText.of(
                                      context,
                                      english: 'Already have an account? ',
                                      romanUrdu: 'Pehle se account hai? ',
                                    ),
                              style: const TextStyle(
                                color: Color(0xFF667085),
                                fontSize: 14,
                            ...
                            GestureDetector(
                              ...
                              child: Text(
                                AppText.of(
                                  context,
                                  english: _isLogin ? 'Sign Up' : 'Sign In',
                                  romanUrdu: _isLogin ? 'Sign Up' : 'Sign In',
                                ),
                                style: const TextStyle(
                                  color: _primary,
                                  fontWeight: FontWeight.w600,
